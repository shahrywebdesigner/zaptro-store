      ...
      <SlickSlider {...settings}>
        {data.slice(0, 7).map((product, index) => {
          return (
            ...
            >
              <div className="flex flex-col my-20 md:flex-row md:my-0 items-center justify-center gap-10 md:gap-20 px-4 md:mx-10 min-h-screen md:h-150 ">
                <div className="">
                  <div className="space-y-3 md:space-y-6">
                    ...
                    <button className="mt-2 cursor-pointer rounded-md text-white px-3 py-2 bg-linear-to-r from-red-500 to-purple-500">
                      Shop Now
                    </button>
                  </div>
                </div>
